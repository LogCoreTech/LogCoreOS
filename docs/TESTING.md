...
## Current Coverage (1030 tests, 59 core files + module_packages/{journal,automations,household,team,chat,notes,dashboard,assets,contacts,finance}/tests/ — all 13 modules in the Mod Store rollout have now converted, see docs/PROJECT.md/docs/MEMORY.md's 2026-08-28 entry)
