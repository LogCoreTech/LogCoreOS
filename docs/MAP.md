...
│   │   ├── module_packages/      → converted modules live here, one dir per id (empty except __init__.py until the first module — journal — actually converts; see docs/MEMORY.md 2026-08-24)
