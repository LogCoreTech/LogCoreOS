...
| `PUT` | `/assets/{id}/comments/visibility` | owner / pool manager | `{hidden: bool}` — hide (or re-show) the comments section for ALL users on this asset; data kept, posting blocked while hidden |
