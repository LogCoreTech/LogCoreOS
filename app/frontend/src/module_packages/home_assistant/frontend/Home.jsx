...
export default function Home() {
  ...
  if (error) {
    return (
      <div className="max-w-2xl mx-auto p-4 space-y-3">
        <h1 className="text-2xl font-bold">Home Assistant</h1>
        <div className="card p-4">
          <p className="text-red-500 text-sm">{error}</p>
          <p className="text-charcoal-400 dark:text-charcoal-500 text-sm mt-2">
            Configure your Home Assistant URL and token in <strong>Admin → Hosting</strong>.
          </p>
        </div>
      </div>
    )
    ...
    return (
      <div className="max-w-2xl mx-auto p-4 space-y-3">
        ...
        <div className="card p-4 text-center text-charcoal-400 dark:text-charcoal-500">
          ...
          <p>No devices found. Connect Home Assistant in <strong>Admin → Hosting</strong>.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-4">
      <span className="flex items-center gap-2"><h1 className="text-2xl font-bold">Home Assistant</h1><HelpButton section="home-assistant" /></span>
