...
// Moved out of the old standalone Settings → Security page (2026-09-20) —
// 2FA now lives as a card on the Account page instead, per owner feedback
// that a single extra page for one feature didn't earn its own nav slot.
