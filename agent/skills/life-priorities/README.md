...
Scores a user's tasks by their life priority hierarchy (Religion → Family → Job → Personal Growth → Hobbies) and surfaces the top 3 most pressing tasks. Also manages recurring task logic and daily priority overrides.
